		...
		Runnable r2 = new Runnable() {
			...
			public void run() {
				for(int i=1; i<=200; i++) {
					...
					try {
						Thread.sleep(100);
						// Thread.sleep(시간) 메서더는 주어진 '시간'동안 작업을 
