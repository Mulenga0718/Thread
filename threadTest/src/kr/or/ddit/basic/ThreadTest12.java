...
import java.util.Random;import javax.naming.directory.InvalidSearchControlsException;
...
public class ThreadTest12 {
	...
	public static void main(String[] args) {
		DisplayCharacter[] ths = new DisplayCharacter[]{
			new DisplayCharacter("홍길동"),new DisplayCharacter("이순신"), new DisplayCharacter("강감찬")};
